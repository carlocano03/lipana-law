        ...
        <div class="row mb-5">
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    <h2 class="logo"><a href="#">Lipana Law <span>Lipana . Bedural . Zoreta</span></a></h2>
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            <li><span class="icon icon-map-marker"></span><span class="text">203 Fake St. Mountain
                                    View, Cabiao, Nueva Ecija, Philippines</span></li>
                            <li><a href="#"><span class="icon icon-phone"></span><span class="text">+2 392 3929
                                        210</span></a></li>
                            <li><a href="#"><span class="icon icon-envelope"></span><span class="text">theBox123@test.com</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<script src="<?= base_url('webAssets/js/jquery.min.js')?>"></script>
<script src="<?= base_url('webAssets/js/jquery-migrate-3.0.1.min.js')?>"></script>
<script src="<?= base_url('webAssets/js/popper.min.js')?>"></script>
<script src="<?= base_url('webAssets/js/bootstrap.min.js')?>"></script>
<script src="<?= base_url('webAssets/js/jquery.easing.1.3.js')?>"></script>
<script src="<?= base_url('webAssets/js/jquery.waypoints.min.js')?>"></script>
<script src="<?= base_url('webAssets/js/jquery.stellar.min.js')?>"></script>
<script src="<?= base_url('webAssets/js/owl.carousel.min.js')?>"></script>
<script src="<?= base_url('webAssets/js/jquery.magnific-popup.min.js')?>"></script>
