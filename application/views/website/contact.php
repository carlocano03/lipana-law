...
<section class="ftco-section contact-section ftco-no-pt ftco-no-pb">
    <div class="container">
        ...
        <div class="row d-flex mb-5 contact-info">
            ...
            <div class="w-100"></div>
            <div class="col-md-3">
                <p><span class="text-white">Address:</span> 203 Fake St. Mountain
                    View, Cabiao, Nueva Ecija, Philippines</p>
            </div>
            <div class="col-md-3">
                <p><span class="text-white">Phone:</span> <a href="tel://1234567920">+ 1235 2355 98</a></p>
            </div>
            <div class="col-md-3">
                <p><span class="text-white">Email:</span> <a href="mailto:info@yoursite.com">theBox123@test.com</a></p>
            </div>
            <div class="col-md-3">
                <p><span class="text-white">Website</span> <a href="#">yoursite.com</a></p>
            </div>
        </div>
        <div class="row block-9 no-gutters">
            <div class="col-lg-6 order-md-last d-flex">
                <form class="bg-light p-5 contact-form" id="consultation">
